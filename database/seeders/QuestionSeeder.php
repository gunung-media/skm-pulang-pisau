    ...
    private function getQuestions(): array
    {
        return [
            [
                ...
                'position' => 1,
                'custom_answers' => json_encode(['Tidak sesuai', 'Kurang sesuai', 'Netral', 'Sesuai', 'Sangat sesuai']),
            ],
            [
                'question' => 'Bagaimana pemahaman Saudara tentang kemudahan prosedur pelayanan di unit ini?',
                'position' => 2,
                'custom_answers' => json_encode(['Tidak mudah', 'Kurang mudah',  'Netral', 'Mudah', 'Sangat mudah']),
            ],
            [
                'question' => 'Bagaimana pendapat Saudara tentang kecepatan waktu dalam memberikan pelayanan?',
                'position' => 3,
                'custom_answers' => json_encode(['Tidak cepat', 'Kurang cepat',  'Netral', 'Cepat', 'Sangat cepat']),
            ],
            [
                'question' => 'Bagaimana pendapat Saudara tentang kewajaran biaya/tarif dalam pelayanan',
                'position' => 4,
                'custom_answers' => json_encode(['Sangat mahal', 'Cukup mahal',  'Netral', 'Murah', 'Gratis']),
            ],
            [
            ...
            [
                ...
                'position' => 6,
                'custom_answers' => json_encode(['Tidak kompeten', 'Kurang kompeten', 'Netral', 'Kompeten', 'Sangat kompeten']),
            ],
            [
                'question' => 'Bagaimana pendapat Saudara tentang perilaku petugas dalam pelayanan terkait kesopanan dan keramahan',
                'position' => 7,
                'custom_answers' => json_encode(['Tidak sopan dan ramah', 'Kurang sopan dan ramah', 'Netral', 'Sopan dan ramah', 'Sangat sopan dan ramah']),
            ],
            [
                'question' => 'Bagaimana pendapat Saudara tentang kualitas sarana dan prasarana',
                'position' => 8,
                'custom_answers' => json_encode(['Buruk', 'Cukup', 'Netral', 'Baik', 'Sangat Baik']),
            ],
            [
                'question' => 'Bagaimana pendapat Saudara tentang penanganan pengaduan pengguna layanan',
                'position' => 9,
                'custom_answers' => json_encode(['Tidak ada', 'Ada tetapi tidak berfungsi', 'Netral', 'Berfungsi kurang maksimal', 'Dikelola dengan baik']),
            ]
        ];
    }
}
